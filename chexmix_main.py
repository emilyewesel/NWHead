...
epochs = 20
num_workers = 4
img_data_dir = "/dataNAS/people/paschali/datasets/chexpert-public/chexpert-public/train/"
...
class DenseNet(pl.LightningModule):
    def __init__(self, num_classes):
        ...
        self.nw_head = NWHead(in_features=num_features, out_features=num_classes)
    ...
    def forward(self, x):
        ...
        return self.nw_head(features)

    def configure_optimizers(self):
        params_to_update = list(self.nw_head.parameters())
    ...
    def training_step(self, batch, batch_idx):
        ...
        wandb.log({'train_loss': loss, 'images': [wandb.Image(grid)]}, step=self.global_step)
        return loss
    ...
    def test_step(self, batch, batch_idx):
        ...
        # wandb.log({'test_loss': loss}, step=self.global_step)
...
def main(hparams):
    ...
    # data
    data = CheXpertDataModule(csv_train_img='/dataNAS/people/paschali/datasets/chexpert-public/chexpert-public/train.csv',
                              csv_val_img='/dataNAS/people/paschali/datasets/chexpert-public/chexpert-public/val.csv',
                              csv_test_img='/dataNAS/people/paschali/datasets/chexpert-public/chexpert-public/test.csv',
